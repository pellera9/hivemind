...
import { readFileSync as readFileSync13, writeFileSync as writeFileSync11, writeSync, mkdirSync as mkdirSync14, renameSync as renameSync7, existsSync as existsSync14, unlinkSync as unlinkSync6, openSync as openSync3, closeSync as closeSync3, statSync as statSync4 } from "node:fs";
...
function recordSessionOwner(sessionId, agentComms = ["claude"], startPid = process.pid) {
  try {
    ...
    if (!owner)
      return;
    mkdirSync14(STATE_DIR, { recursive: true });

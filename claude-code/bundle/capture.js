...
import { readFileSync as readFileSync5, writeFileSync as writeFileSync4, writeSync, mkdirSync as mkdirSync4, renameSync as renameSync2, existsSync as existsSync3, unlinkSync as unlinkSync3, openSync as openSync2, closeSync as closeSync2, statSync as statSync2 } from "node:fs";
...
import { existsSync as existsSync8, lstatSync as lstatSync2, mkdirSync as mkdirSync10, readFileSync as readFileSync9, renameSync as renameSync5, unlinkSync as unlinkSync5, writeFileSync as writeFileSync9 } from "node:fs";
...
// dist/src/embeddings/client.js
var SHARED_DAEMON_PATH = join17(homedir10(), ".hivemind", "embed-deps", "embed-daemon.js");
...
import { existsSync as existsSync10, mkdirSync as mkdirSync11, readFileSync as readFileSync11, renameSync as renameSync6, writeFileSync as writeFileSync10 } from "node:fs";
import { homedir as homedir11 } from "node:os";
import { dirname as dirname6, join as join18 } from "node:path";
var _configPath = () => process.env.HIVEMIND_CONFIG_PATH ?? join18(homedir11(), ".deeplake", "config.json");
var _cache = null;
var _migrated = false;
...
function defaultResolveTransformers() {
  const sharedDir = join19(homedir12(), ".hivemind", "embed-deps");
  try {
...
import { existsSync as existsSync11, lstatSync as lstatSync3, mkdirSync as mkdirSync12, readlinkSync, renameSync as renameSync7, rmSync, symlinkSync, statSync as statSync3 } from "node:fs";
...
function ensurePluginNodeModulesLink(opts) {
  ...
  const target = opts.sharedNodeModules ?? join20(homedir13(), ".hivemind", "embed-deps", "node_modules");
  const pluginDir = dirname7(opts.bundleDir);
  const link = join20(pluginDir, "node_modules");
...
function createSymlinkAtomic(target, link) {
  try {
    const parent = dirname7(link);
    if (!existsSync11(parent))
      mkdirSync12(parent, { recursive: true });

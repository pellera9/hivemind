...
import { join as join20, dirname as dirname9, sep } from "node:path";
...
import { existsSync as existsSync3, lstatSync, mkdirSync, readFileSync as readFileSync2, renameSync as renameSync2, unlinkSync, writeFileSync } from "node:fs";
...
function migrateLegacyStateDir() {
  ...
  const legacy = join4(dirname(current), "skilify");
...
function armSkillOptOnSkillUse(sessionId, toolName, toolInput, toolUseId) {
  try {
    if (toolName !== "Skill" || process.env[SKILLOPT_ENV.DISABLED] === "1")
      return;
    const ref = toolInput?.skill;
...
import { readFileSync as readFileSync3, writeFileSync as writeFileSync2, renameSync as renameSync3, mkdirSync as mkdirSync2, openSync, closeSync, unlinkSync as unlinkSync2, statSync } from "node:fs";
...
async function withQueueLock(fn) {
  ...
  mkdirSync2(join6(homedir4(), ".deeplake"), { recursive: true, mode: 448 });
  let fd = null;
...
import { readFileSync as readFileSync4, writeFileSync as writeFileSync3, mkdirSync as mkdirSync3, unlinkSync as unlinkSync3 } from "node:fs";
...
import { existsSync as existsSync6, mkdirSync as mkdirSync5, readFileSync as readFileSync7, renameSync as renameSync4, writeFileSync as writeFileSync5 } from "node:fs";
...
function resolveDaemonPath() {
  return join12(dirname4(fileURLToPath3(import.meta.url)), "..", "embeddings", "embed-daemon.js");
}
...
import { existsSync as existsSync9, mkdirSync as mkdirSync9, readFileSync as readFileSync10, renameSync as renameSync7, writeFileSync as writeFileSync8 } from "node:fs";
import { createHash as createHash3 } from "node:crypto";
import { join as join16, dirname as dirname8 } from "node:path";

// dist/src/graph/last-build.js
import { existsSync as existsSync7, mkdirSync as mkdirSync6, readFileSync as readFileSync8, renameSync as renameSync5, writeFileSync as writeFileSync6 } from "node:fs";
...
import { mkdirSync as mkdirSync8, renameSync as renameSync6, writeFileSync as writeFileSync7 } from "node:fs";
...
import { mkdirSync as mkdirSync10, readFileSync as readFileSync11, rmSync, writeFileSync as writeFileSync9 } from "node:fs";
...
import { readFileSync as readFileSync12, writeFileSync as writeFileSync10, writeSync as writeSync2, mkdirSync as mkdirSync11, renameSync as renameSync8, existsSync as existsSync10, unlinkSync as unlinkSync5, openSync as openSync3, closeSync as closeSync3, statSync as statSync2 } from "node:fs";
...
function recordSessionOwner(sessionId, agentComms = ["claude"], startPid = process.pid) {
  try {
    ...
    if (!owner)
      return;
    mkdirSync11(STATE_DIR, { recursive: true });
...
function writeReadCacheFile(sessionId, virtualPath, content, deps = {}) {
  ...
  mkdirSync12(dirname9(absPath), { recursive: true });
